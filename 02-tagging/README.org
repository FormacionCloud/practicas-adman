...
- [[https://docs.aws.amazon.com/IAM/latest/UserGuide/introduction_attribute-based-access-control.html][Definición de permisos en función de los atributos con la autorización de ABAC]]
...
- *Rol* de ejecución de IAM que incluya la política ~AmazonSSMManagedEC2InstanceDefaultPolicy~. El nombre del rol debe tenet tu *NOMBRE* y *APELLIDOS*
