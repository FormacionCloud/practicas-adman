...
En el apartado de infraestructura, selecciona una única máquina EC2.

A la hora de seleccionar el código, elegiremos desplegar la *aplicación de prueba*.

Por último, accede a la URL de la aplicación y comprueba que se muestra la aplicación de ejemplo de AWS.
