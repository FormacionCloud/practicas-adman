...
En esta práctica configuraremos el servicio EventBridge para enviar eventos a un bus de eventos disponible en la cuenta de AWS del profesor.
...
A continuación puedes ver cómo configurar el destino en la seccion /Select target/ del asistente:
[[./imagenes/06-target.png]]

* Entrega
Antes de realizar la entrega del documento, *pon en marcha* o *detén* alguna máquina virtual de EC2 y *envía un mensaje al profesor* para que compruebe si el evento ha sido recibido correctamente. Una vez tengas la confirmación, puedes hacer la entrega del documento.
