...
** Tareas a realizar
Utilizando como base uno de los repositorios de ejemplo propuestos en la [[https://github.com/FormacionCloud/CursoEspecializacion/blob/main/teoria/integracion-continua-testeo.org][teoría de GitHub Actions]] ([[https://github.com/curso-github-cefire/tdd-node-sample-actions][Node con GitHub Actions]] o [[https://github.com/curso-github-cefire/tdd-python-sample][Python con GitHub Actions]]), crea un repositorio *en tu cuenta de GitHub*. Dicho repositorio debe contener una función que compruebe si un número dado es par y un test que realice pruebas con varios números para comprobar que la función está correctamente diseñada. Puedes utilizar cualquier lenguaje de programación soportado por GitHub Actions.
